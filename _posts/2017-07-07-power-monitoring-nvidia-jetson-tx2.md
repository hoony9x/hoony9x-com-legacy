...
~~아래 내용은 [다음 링크](https://devtalk.nvidia.com/default/topic/950341/jetson-tx1/jetson-tx1-ina226-power-monitor-with-i2c-interface-/post/4998393/#4998393)를 참고하였다. (TX1에 관한 글이지만 TX2에서 확인 결과 같은 동작을 한다.)~~  
...
이 정보는 __해당 파일을 읽는 순간의 값(Instant value)__ 을 표시하게 된다.
